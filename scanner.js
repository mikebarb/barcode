    ...
    // Function to trigger a scan taking of current state.
    function triggerScan() {
        console.log("Trigger scan called.");
        // show the scan area to the user
        const areaScanDisplay = document.getElementById('scan-display');
        //scannerContainer.classList.remove('hideme');   
        ...
        console.log("isScanning: ", isScanning, " isPaused: ", isPaused);
        if (isScanning && !isPaused) {
            console.log("pause then resume");
            pauseScanning();
            resumeScanning();
            //return;
        } 
